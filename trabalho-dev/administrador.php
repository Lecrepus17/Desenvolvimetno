<?php
    ...
    $sql = $conex->query('SELECT alunos.senha, alunos.nome_aluno, alunos.data_nasc, turmas.nome_turma, alunos.foto, nivel_ensino.nome_nivel, cursos.nome_curso, alunos.idalunos FROM alunos 
